...
class Games 
{
    ...
    public function get_stats() {
        ...
        $games_completed = mysqli_result($result,0,0);
        $games_won_by_evil = mysqli_result($result,0,1);
        $games_won_by_good = mysqli_result($result,0,2);
        $games_won_by_other = mysqli_result($result,0,3);
        $games_in_progress = mysqli_result($result,0,4);
    ...
    private function process_game_data($games_data) {
        ...
        while ( $game_data = mysqli_fetch_array($games_data, MYSQLI_ASSOC) ) {
            $game_data['mods'] = $game_data['mods'] ?? '';
            $games[] = [
                'id' => $game_data['id'],
