...
function show_deadlines() {
  ...
  if ( fast == "Fast" ) {
    document.getElementById('deadlines').style.visibility='hidden'
    document.getElementById('deadlines').style.position='absolute'
    document.getElementById('cycle_lengths').style.visibility='visible'
    document.getElementById('cycle_lengths').style.position='relative'
  } else {
    document.getElementById('deadlines').style.visibility='visible'
    document.getElementById('deadlines').style.position='relative'
    document.getElementById('cycle_lengths').style.visibility='hidden'
    document.getElementById('cycle_lengths').style.position='absolute'
  }
}
...
<tr><td align='right'>Deadlines</td>
  <td>
  <div id='deadlines' style='visibility:visible; position:relative;'>
  ...
  <div id='cycle_lengths' style='visibility:hidden; position:absolute;'>
  <table cellspacing='0' cellpadding='0'>
