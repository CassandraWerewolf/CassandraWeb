...
function getChatText() {
  if (receiveReq.readyState == 4 || receiveReq.readyState == 0) {
    ...
    receiveReq.open("GET", dir+'new_get_game_chat.php?room_id='+room_id+'&last='+lastMessage, true);
...
function sendChatText() {
  ...
  if (sendReq.readyState == 4 || sendReq.readyState == 0) {
    sendReq.open("POST", dir+'new_get_game_chat.php?room_id='+room_id+'&last='+lastMessage, true);
