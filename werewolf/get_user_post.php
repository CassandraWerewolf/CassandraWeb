...
if (mysqli_num_rows($result) == 1 ) { 
  ...
  $game_name = mysqli_result($result,0,1);
} else {
  $game_id = 0;
...
{
	$dumped_time = mysqli_result($result,0,0);
...
$result = mysqli_query($mysql, $first_game_post_sql);
$first_game_post_article_id = mysqli_result($result,0,0);
?>
<html>
<head>
